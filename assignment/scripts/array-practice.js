...
// 3.b. TODO: Log the last animal in the array using it's array index 
    ...
    console.log('the last animal is', animalArray[2])
...
// 4.a. TODO: Add a new food at the end of your array & log the array
    ...
    favoriteFoods.push('enjera');
    console.log('added an additional food at the end of,', favoriteFoods)
...
// 4.c. TODO: Add a food at the beginning of the array & log the array
    ...
    favoriteFoods.unshift('shawerma');
    console.log(`Added a new food at the beginning: ${favoriteFoods}`);
...
//      Then log the updated array.
    ...
    favoriteFoods[1] = 'burger'
    console.log('Changed my second favorite food to',favoriteFoods[1]);
    console.log('My favorite foods are now',favoriteFoods);
...
//console.log(favoriteFoods.toString());
    ...
    reversed_favoriteFoods = favoriteFoods.join(' and ');
    console.log('My favorite foods are', reversed_favoriteFoods);
